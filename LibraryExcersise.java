...
public class LibraryExcersise {
    ...
    public static void main(String[] args) {
        ...
        Labrarian lab = new Labrarian(lib);
     
       
        System.out.println("----- Details for Book7 -----");
        lab.findMeBook("Book7");
        
        System.out.println();
        
        System.out.println("----- AVAILABLE BOOKS -----");
        lab.findMeAvailableBooks();
       
         System.out.println();
       
         System.out.println("----- DIANES'S BOOKS -----");
         lab.findMeBooksFromAuthor(diane);
         
          System.out.println();
          
        System.out.println("----- THE MOST POPULAR BOOK -----");
        lab.findMostPopularBook();
